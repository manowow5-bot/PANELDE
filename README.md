...
## Usuarios en cualquier dispositivo (opcional)

Por defecto, esta app guarda usuarios en `localStorage` (solo dispositivo actual).
Si quieres que un usuario registrado pueda iniciar sesión en cualquier dispositivo, activa autenticación en la nube:
